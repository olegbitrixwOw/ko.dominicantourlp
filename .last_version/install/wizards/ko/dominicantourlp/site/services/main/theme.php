...
CopyDirFiles(
$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/".$this->MODULE_ID."/install/wizards/ko/dominicantourlp/site/templates/dominicantourlp_by_ko/themes/".WIZARD_THEME_ID."/".WIZARD_THEME_ID."css", 
$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/".$this->MODULE_ID."/install/wizards/ko/dominicantourlp/site/templates/dominicantourlp_by_ko/".WIZARD_THEME_ID."css");
